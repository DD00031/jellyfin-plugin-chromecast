...
#pragma warning restore CA5359 // Do Not Disable Certificate Validation
        ...
        /// <summary>
        /// Registers an additional channel (e.g. for a custom, non-media namespace) so it
        /// receives dispatched messages and can be retrieved later via <see cref="GetChannel{TChannel}"/>.
        /// Patch: upstream only wires up its fixed built-in channel list in the constructor with
        /// no way to add more; see PATCH.md for why the Jellyfin Chromecast plugin needs this.
        /// </summary>
        /// <param name="channel">The channel to register. Must not already be connected via
        /// <see cref="ConnectChromecast"/> - call this before connecting.</param>
